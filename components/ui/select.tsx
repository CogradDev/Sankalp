...
function SelectContent({
  ...
  // Check if explicit colors are provided - if so, exclude CSS variable classes
  const hasExplicitColors = className?.includes('!bg-') || className?.includes('!text-')
  const baseClasses = hasExplicitColors
...
function SelectItem({
  ...
  // Check if explicit text color is provided - if so, exclude CSS variable classes
  const hasExplicitTextColor = className?.includes('!text-')
  const baseClasses = hasExplicitTextColor
